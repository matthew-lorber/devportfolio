...
function parallaxFx() {
    ...
    $('#test').css({'transform':'translateX('+10*d.x/ctr.x+'px) translateY('+10*d.y/ctr.y+'px) rotateY('+r.x+'deg) rotateX('+r.y+'deg)'});
    $('#test2').css({'transform':'translateX('+40*d.x/ctr.x+'px) translateY('+40*d.y/ctr.y+'px) rotateY('+r.x+'deg) rotateX('+r.y+'deg)'});
};
...
function mouseFx() {
    ...
    $("section").css("transform","scale(1.2)");
}
